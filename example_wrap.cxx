...
#define SWIGTYPE_p_Square swig_types[0]
...
#define SWIGTYPE_p_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t swig_types[9]
#define SWIGTYPE_p_std__lessT_int_t swig_types[10]
#define SWIGTYPE_p_std__lessT_swig__GC_VALUE_t swig_types[11]
#define SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t swig_types[12]
#define SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator swig_types[13]
#define SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator swig_types[14]
...
SWIGINTERN std::set< int,std::less< int >,std::allocator< int > > *std_set_Sl_int_Sg__dup(std::set< int > *self){
      return new std::set<int,std::less< int >,std::allocator< int > >(*self);
    }
SWIGINTERN VALUE std_set_Sl_int_Sg__inspect(std::set< int > *self){
      std::set<int,std::less< int >,std::allocator< int > >::const_iterator i = self->begin();
      std::set<int,std::less< int >,std::allocator< int > >::const_iterator e = self->end();
      const char *type_name = swig::type_name< std::set<int,std::less< int >,std::allocator< int > > >();
      VALUE str = rb_str_new2(type_name);
      str = rb_str_cat2( str, " [" );
      bool comma = false;
      VALUE tmp;
	...
	{
	  if (comma) str = rb_str_cat2( str, "," );
	  tmp = swig::from< std::set<int,std::less< int >,std::allocator< int > >::value_type >( *i );
	  tmp = rb_inspect( tmp );
	  str = rb_str_buf_append( str, tmp );
	}
      str = rb_str_cat2( str, "]" );
...
SWIGINTERN VALUE std_set_Sl_int_Sg__to_a(std::set< int > *self){
      std::set<int,std::less< int >,std::allocator< int > >::const_iterator i = self->begin();
      std::set<int,std::less< int >,std::allocator< int > >::const_iterator e = self->end();
      VALUE ary = rb_ary_new2( std::distance( i, e ) );
      VALUE tmp;
...
SWIGINTERN VALUE std_set_Sl_int_Sg__to_s(std::set< int > *self){
      std::set<int,std::less< int >,std::allocator< int > >::iterator i = self->begin();
      std::set<int,std::less< int >,std::allocator< int > >::iterator e = self->end();
      VALUE str = rb_str_new2( "" );
      VALUE tmp;
      for ( ; i != e; ++i )
	{
...
SWIGINTERN VALUE std_set_Sl_int_Sg__slice(std::set< int > *self,std::set< int >::difference_type i,std::set< int >::difference_type j){
	if ( j <= 0 ) return Qnil;
	std::size_t len = self->size();
	if ( i < 0 ) i = len - i;
	j += i;
	...
	VALUE r = Qnil;
	try {
	  r = swig::from< const std::set<int,std::less< int >,std::allocator< int > >* >( swig::getslice(self, i, j) );
	}
	catch( std::out_of_range )
	  {
	  }
...
SWIGINTERN std::set< int,std::less< int >,std::allocator< int > > *std_set_Sl_int_Sg__each(std::set< int > *self){
	if ( !rb_block_given_p() )
	  rb_raise( rb_eArgError, "no block given");
	...
	for ( ; i != e; ++i )
	  {
	    r = swig::from< std::set<int,std::less< int >,std::allocator< int > >::value_type >(*i);
	    rb_yield(r);
	  }
	
	return self;
      }
SWIGINTERN std::set< int,std::less< int >,std::allocator< int > > *std_set_Sl_int_Sg__select(std::set< int > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );

      std::set<int,std::less< int >,std::allocator< int > >* r = new std::set<int,std::less< int >,std::allocator< int > >;
      std::set<int,std::less< int >,std::allocator< int > >::const_iterator i = self->begin();
      std::set<int,std::less< int >,std::allocator< int > >::const_iterator e = self->end();
      for ( ; i != e; ++i )
	{
	  VALUE v = swig::from< std::set<int,std::less< int >,std::allocator< int > >::value_type >(*i);
	  if ( RTEST( rb_yield(v) ) )
	    self->insert( r->end(), *i);
	}
...
SWIGINTERN VALUE std_set_Sl_int_Sg__delete_at(std::set< int > *self,std::set< int >::difference_type i){
      VALUE r = Qnil;
      try {
	std::set<int,std::less< int >,std::allocator< int > >::iterator at = swig::getpos(self, i);
	r = swig::from< std::set<int,std::less< int >,std::allocator< int > >::value_type >( *(at) );
	self->erase(at); 
      }
      catch (std::out_of_range)
	{
...
SWIGINTERN VALUE std_set_Sl_int_Sg____delete2__(std::set< int > *self,std::set< int >::value_type const &i){
      VALUE r = Qnil;
      return r;
    }
SWIGINTERN std::set< int,std::less< int >,std::allocator< int > > *std_set_Sl_int_Sg__reject_bang(std::set< int > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );

      for ( std::set<int,std::less< int >,std::allocator< int > >::iterator i = self->begin(); i != self->end(); ) {
        VALUE r = swig::from< std::set<int,std::less< int >,std::allocator< int > >::value_type >(*i);
        std::set<int,std::less< int >,std::allocator< int > >::iterator current = i++;
        if ( RTEST( rb_yield(r) ) )
          self->erase(current);
      }
...
SWIGINTERN std::set< int >::value_type std_set_Sl_int_Sg__push(std::set< int > *self,std::set< int >::value_type const &x){
      self->insert(x);
      return x;
    }
SWIGINTERN bool std_set_Sl_int_Sg____contains__(std::set< int > *self,std::set< int >::value_type const &x){
...
namespace swig {
  ...
  namespace swig {
	...
	return obj;
      ...
      namespace swig {
	template <>  struct traits<std::pair< swig::GC_VALUE, swig::GC_VALUE > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::pair<" "swig::GC_VALUE" "," "swig::GC_VALUE" " >";
	  }
	};
      }
  ...
  namespace swig {
	...
	if (desc && desc->clientdata) {
      ...
      namespace swig {
	template <>  struct traits<std::map<swig::GC_VALUE, swig::GC_VALUE, std::less< swig::GC_VALUE >, std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::map<" "swig::GC_VALUE" "," "swig::GC_VALUE" "," "std::less< swig::GC_VALUE >" "," "std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > >" " >";
	  }
	};
      }
    
SWIGINTERN std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__dup(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
      return new std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >(*self);
    }
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg____delete__(std::map< swig::GC_VALUE,swig::GC_VALUE > *self,std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &key){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::iterator i = self->find(key);
      if (i != self->end()) {
	self->erase(i);
...
SWIGINTERN bool std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__has_key(std::map< swig::GC_VALUE,swig::GC_VALUE > const *self,std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &key){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator i = self->find(key);
      return i != self->end();
    }
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__keys(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::size_type size = self->size();
      int rubysize = (size <= (std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::size_type) INT_MAX) ? (int) size : -1;
      if (rubysize < 0) {
	SWIG_RUBY_THREAD_BEGIN_BLOCK;
	rb_raise(rb_eRuntimeError, "map size not valid in Ruby");
	SWIG_RUBY_THREAD_END_BLOCK;
	return Qnil;
      ...
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator i = self->begin();
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator e = self->end();
      for ( ; i != e; ++i ) {
	rb_ary_push( ary, swig::from(i->first) );
      }
      return ary;
    }
SWIGINTERN std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__each(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
	if ( !rb_block_given_p() )
	  rb_raise( rb_eArgError, "no block given");

	VALUE k, v;
	std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::iterator i = self->begin();
	std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::iterator e = self->end();
	for ( ; i != e; ++i )
	  {
	    const std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::key_type&    key = i->first;
	    const std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::mapped_type& val = i->second;

	    k = swig::from<std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::key_type>(key);
	    v = swig::from<std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::mapped_type>(val);
	    rb_yield_values(2, k, v);
	  }
	
	return self;
      }
SWIGINTERN std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__select(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
      if ( !rb_block_given_p() )
	rb_raise( rb_eArgError, "no block given" );

      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >* r = new std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >;
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::iterator i = self->begin();
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::iterator e = self->end();
      for ( ; i != e; ++i )
	{
	  VALUE k = swig::from<std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::key_type>(i->first);
	  VALUE v = swig::from<std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::mapped_type>(i->second);
...
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__values_at(std::map< swig::GC_VALUE,swig::GC_VALUE > *self,int argc,VALUE *argv,...){
    
    VALUE r = rb_ary_new();
    ID   id = rb_intern("[]");
    swig_type_info* type = swig::type_info< std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > >();
...
SWIGINTERN std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__each_key(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
	if ( !rb_block_given_p() )
	  rb_raise( rb_eArgError, "no block given");
...
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__values(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::size_type size = self->size();
      int rubysize = (size <= (std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::size_type) INT_MAX) ? (int) size : -1;
      if (rubysize < 0) {
	SWIG_RUBY_THREAD_BEGIN_BLOCK;
...
SWIGINTERN std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__each_value(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
	if ( !rb_block_given_p() )
	  rb_raise( rb_eArgError, "no block given");
...
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__entries(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::size_type size = self->size();
      int rubysize = (size <= (std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::size_type) INT_MAX) ? (int) size : -1;
      if (rubysize < 0) {
	SWIG_RUBY_THREAD_BEGIN_BLOCK;
	...
	return Qnil;
      ...
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator e = self->end();
      for ( ; i != e; ++i ) {
	rb_ary_push( ary, swig::from<std::pair<std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::key_type, 
		     std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::mapped_type> >(*i) );
      }
      return ary;
    }
SWIGINTERN bool std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg____contains__(std::map< swig::GC_VALUE,swig::GC_VALUE > *self,std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &key){
      return self->find(key) != self->end();
    }
SWIGINTERN swig::ConstIterator *std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__key_iterator(std::map< swig::GC_VALUE,swig::GC_VALUE > *self,VALUE *RUBY_SELF){
      return swig::make_output_key_iterator(self->begin(), self->begin(), 
					    self->end(), *RUBY_SELF);
    }
SWIGINTERN swig::ConstIterator *std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__value_iterator(std::map< swig::GC_VALUE,swig::GC_VALUE > *self,VALUE *RUBY_SELF){
      return swig::make_output_value_iterator(self->begin(), self->begin(), 
					      self->end(), *RUBY_SELF);
    }
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg____getitem__(std::map< swig::GC_VALUE,swig::GC_VALUE > const *self,std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &key){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator i = self->find(key);
      if ( i != self->end() )
	return swig::from<std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::mapped_type>( i->second );
      else
	return Qnil;
    }
SWIGINTERN void std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg____setitem__(std::map< swig::GC_VALUE,swig::GC_VALUE > *self,std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &key,std::map< swig::GC_VALUE,swig::GC_VALUE >::mapped_type const &x){
      (*self)[key] = x;
    }
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__inspect(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator i = self->begin();
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator e = self->end();
      const char *type_name = swig::type_name< std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > >();
      VALUE str = rb_str_new2( type_name );
      str = rb_str_cat2( str, " {" );
      bool comma = false;
      VALUE tmp;
	...
	{
	  if (comma) str = rb_str_cat2( str, "," );
	  tmp = swig::from< std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::key_type >( i->first );
	  tmp = rb_inspect( tmp );
	  str = rb_str_buf_append( str, tmp );
	  str = rb_str_cat2( str, "=>" );
	  tmp = swig::from< std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::mapped_type >( i->second );
	  tmp = rb_inspect( tmp );
	  str = rb_str_buf_append( str, tmp );
	}
      str = rb_str_cat2( str, "}" );
...
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__to_a(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator i = self->begin();
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::const_iterator e = self->end();
      VALUE ary = rb_ary_new2( std::distance( i, e ) );
      VALUE tmp;
      for ( ; i != e; ++i )
	{
	  ...
	  tmp = swig::from< std::pair<std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::key_type, 
	    std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::mapped_type> >( *i );
	  rb_ary_push( ary, tmp );
	}
      return ary;
    }
SWIGINTERN VALUE std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__to_s(std::map< swig::GC_VALUE,swig::GC_VALUE > *self){
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::iterator i = self->begin();
      std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::iterator e = self->end();
      VALUE str = rb_str_new2( "" );
      VALUE tmp;
...
static swig_class SwigClassSquare;

#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_Square_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_Square_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_Square);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
...
SWIGINTERN VALUE
_wrap_new_Square(int argc, VALUE *argv, VALUE self) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "int","Square", 1, argv[0] ));
  } 
  arg1 = static_cast< int >(val1);
  ecode2 = SWIG_AsVal_int(argv[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "int","Square", 2, argv[1] ));
  } 
  arg2 = static_cast< int >(val2);
  result = (Square *)new Square(arg1,arg2);
...
SWIGINTERN VALUE
_wrap_Square_x_set(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Square, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Square *","x", 1, self )); 
  }
...
SWIGINTERN VALUE
_wrap_Square_x_get(int argc, VALUE *argv, VALUE self) {
  Square *arg1 = (Square *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
...
SWIGINTERN VALUE
_wrap_Square_y_set(int argc, VALUE *argv, VALUE self) {
  Square *arg1 = (Square *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Square, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Square *","y", 1, self )); 
  }
  arg1 = reinterpret_cast< Square * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
SWIGINTERN VALUE
_wrap_Square_y_get(int argc, VALUE *argv, VALUE self) {
  Square *arg1 = (Square *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
...
SWIGINTERN VALUE
_wrap_Square_area(int argc, VALUE *argv, VALUE self) {
  Square *arg1 = (Square *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Square, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Square *","area", 1, self )); 
  }
  arg1 = reinterpret_cast< Square * >(argp1);
  (arg1)->area();
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Square_perimeter(int argc, VALUE *argv, VALUE self) {
  Square *arg1 = (Square *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Square, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Square *","perimeter", 1, self )); 
  }
  arg1 = reinterpret_cast< Square * >(argp1);
  (arg1)->perimeter();
  return Qnil;
...
SWIGINTERN void
free_Square(Square *arg1) {
    delete arg1;
}

SWIGINTERN VALUE
_wrap_fibonacci(int argc, VALUE *argv, VALUE self) {
  long long arg1 ;
  long long val1 ;
  int ecode1 = 0 ;
  long long result;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "long long","fibonacci", 1, argv[0] ));
  } 
  arg1 = static_cast< long long >(val1);
  result = (long long)fibonacci(arg1);
...
/*
  Document-method: Example::IntVector.dup
...
/*
  Document-method: Example::IntVector.inspect
...
/*
  Document-method: Example::IntVector.to_a
...
/*
  Document-method: Example::IntVector.to_s
...
/*
  Document-method: Example::IntVector.slice
...
/*
  Document-method: Example::IntVector.each
...
/*
  Document-method: Example::IntVector.select
...
/*
  Document-method: Example::IntVector.delete_at
...
/*
  Document-method: Example::IntVector.reject!
...
/*
  Document-method: Example::IntVector.pop
...
/*
  Document-method: Example::IntVector.push
...
/*
  Document-method: Example::IntVector.at
...
/*
  Document-method: Example::IntVector.[]
...
/*
  Document-method: Example::IntVector.shift
...
/*
  Document-method: Example::IntVector.insert
...
/*
  Document-method: Example::IntVector.unshift
...
/*
  Document-method: Example::IntVector.empty?
...
/*
  Document-method: Example::IntVector.size
...
/*
  Document-method: Example::IntVector.clear
...
/*
  Document-method: Example::IntVector.begin
...
/*
  Document-method: Example::IntVector.end
...
/*
  Document-method: Example::IntVector.rbegin
...
/*
  Document-method: Example::IntVector.rend
...
/*
  Document-method: Example::IntVector.resize
...
/*
  Document-method: Example::IntVector.erase
...
/*
  Document-method: Example::IntVector.front
...
/*
  Document-method: Example::IntVector.back
...
/*
  Document-method: Example::IntVector.assign
...
/*
  Document-method: Example::IntVector.reserve
...
/*
  Document-method: Example::IntVector.capacity
...
/*
  Document-method: Example::IntVector.__delete__
...
static swig_class SwigClassIntSet;

SWIGINTERN VALUE
_wrap_new_IntSet__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::less< int > *arg1 = 0 ;
  void *argp1 ;
  int res1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::less< int > const &","set<(int)>", 1, argv[0] )); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::less< int > const &","set<(int)>", 1, argv[0])); 
  }
...
/*
  Document-method: Example::IntSet.dup
...
*/
SWIGINTERN VALUE
_wrap_IntSet_dup(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","dup", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (std::set< int,std::less< int >,std::allocator< int > > *)std_set_Sl_int_Sg__dup(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  Document-method: Example::IntSet.inspect
...
*/
SWIGINTERN VALUE
_wrap_IntSet_inspect(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","inspect", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (VALUE)std_set_Sl_int_Sg__inspect(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.to_a

  call-seq:
    to_a -> VALUE

Convert IntSet to an Array.
*/
SWIGINTERN VALUE
_wrap_IntSet_to_a(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","to_a", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (VALUE)std_set_Sl_int_Sg__to_a(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.to_s
...
*/
SWIGINTERN VALUE
_wrap_IntSet_to_s(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","to_s", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (VALUE)std_set_Sl_int_Sg__to_s(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.slice

  call-seq:
    slice(i, j) -> VALUE

Return a slice (portion of) the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_slice(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::difference_type arg2 ;
  std::set< int >::difference_type arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","slice", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::difference_type","slice", 2, argv[0] ));
  } 
  arg2 = static_cast< std::set< int >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "std::set< int >::difference_type","slice", 3, argv[1] ));
  } 
  arg3 = static_cast< std::set< int >::difference_type >(val3);
  result = (VALUE)std_set_Sl_int_Sg__slice(arg1,arg2,arg3);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.each

  call-seq:
    each -> IntSet

Iterate thru each element in the IntSet.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_IntSet_each(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::set< int,std::less< int >,std::allocator< int > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","each", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (std::set< int,std::less< int >,std::allocator< int > > *)std_set_Sl_int_Sg__each(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  Document-method: Example::IntSet.select

  call-seq:
    select -> IntSet

Iterate thru each element in the IntSet and select those that match a condition.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_IntSet_select(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::set< int,std::less< int >,std::allocator< int > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","select", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (std::set< int,std::less< int >,std::allocator< int > > *)std_set_Sl_int_Sg__select(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.delete_at
...
*/
SWIGINTERN VALUE
_wrap_IntSet_delete_at(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","delete_at", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::difference_type","delete_at", 2, argv[0] ));
  } 
  arg2 = static_cast< std::set< int >::difference_type >(val2);
  result = (VALUE)std_set_Sl_int_Sg__delete_at(arg1,arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_IntSet___delete2__(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","__delete2__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::value_type","__delete2__", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::value_type >(val2);
  arg2 = &temp2;
  result = (VALUE)std_set_Sl_int_Sg____delete2__(arg1,(int const &)*arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.reject!

  call-seq:
    reject! -> IntSet

Iterate thru each element in the IntSet and reject those that fail a condition.  A block must be provided.  IntSet is modified in place.
*/
SWIGINTERN VALUE
_wrap_IntSet_rejectN___(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::set< int,std::less< int >,std::allocator< int > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","reject_bang", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (std::set< int,std::less< int >,std::allocator< int > > *)std_set_Sl_int_Sg__reject_bang(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.push

  call-seq:
    push(x) -> std::set< int >::value_type

Add an element at the end of the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_push(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","push", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::value_type","push", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::value_type >(val2);
  arg2 = &temp2;
  result = (std::set< int >::value_type)std_set_Sl_int_Sg__push(arg1,(int const &)*arg2);
  vresult = SWIG_From_int(static_cast< int >(result));
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_IntSet_includeq___(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","__contains__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::value_type","__contains__", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::value_type >(val2);
  arg2 = &temp2;
  result = (bool)std_set_Sl_int_Sg____contains__(arg1,(int const &)*arg2);
  vresult = SWIG_From_bool(static_cast< bool >(result));
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.[]

  call-seq:
    [](i) -> std::set< int >::value_type

Element accessor/slicing.
*/
SWIGINTERN VALUE
_wrap_IntSet___getitem__(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::difference_type arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > const *","__getitem__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::difference_type","__getitem__", 2, argv[0] ));
  } 
  arg2 = static_cast< std::set< int >::difference_type >(val2);
  try {
...
SWIGINTERN VALUE
_wrap_new_IntSet__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::set< int > *result = 0 ;
...
#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_IntSet_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_IntSet_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_IntSet__SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  std::set< int > *result = 0 ;
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > const &","set<(int)>", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::set< int > const &","set<(int)>", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
SWIGINTERN VALUE _wrap_new_IntSet(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[1];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_IntSet__SWIG_1(nargs, args, self);
  }
  if (argc == 1) {
    int _v;
    void *vptr = 0;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_IntSet__SWIG_0(nargs, args, self);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_IntSet__SWIG_2(nargs, args, self);
    }
  }
  
fail:
  Ruby_Format_OverloadedError( argc, 1, "IntSet.new", 
    "    IntSet.new(std::less< int > const &)\n"
    "    IntSet.new()\n"
    "    IntSet.new(std::set< int > const &)\n");
...
/*
  Document-method: Example::IntSet.empty?

  call-seq:
    empty? -> bool

Check if the IntSet is empty or not.
*/
SWIGINTERN VALUE
_wrap_IntSet_emptyq___(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  bool result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > const *","empty", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
...
/*
  Document-method: Example::IntSet.size

  call-seq:
    size -> std::set< int >::size_type

Size or Length of the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_size(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > const *","size", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
...
/*
  Document-method: Example::IntSet.clear

  call-seq:
    clear

Clear IntSet contents.
*/
SWIGINTERN VALUE
_wrap_IntSet_clear(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","clear", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  (arg1)->clear();
  return Qnil;
...
SWIGINTERN VALUE
_wrap_IntSet_swap(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","swap", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::set< int > &","swap", 2, argv[0] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::set< int > &","swap", 2, argv[0])); 
  }
...
/*
  Document-method: Example::IntSet.erase

  call-seq:
    erase(x) -> std::set< int >::size_type
    erase(pos)
    erase(first, last)

Delete a portion of the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_erase__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","erase", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::key_type","erase", 2, argv[0] ));
  } 
...
SWIGINTERN VALUE
_wrap_IntSet_count(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > const *","count", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::key_type","count", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::key_type >(val2);
  arg2 = &temp2;
...
/*
  Document-method: Example::IntSet.begin

  call-seq:
    begin -> std::set< int >::iterator

Return an iterator to the beginning of the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_begin(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","begin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (arg1)->begin();
  vresult = SWIG_NewPointerObj(swig::make_set_nonconst_iterator(static_cast< const std::set< int >::iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  return vresult;
fail:
...
/*
  Document-method: Example::IntSet.end

  call-seq:
    end -> std::set< int >::iterator

Return an iterator to past the end of the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_end(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::set< int >::iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","end", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (arg1)->end();
  vresult = SWIG_NewPointerObj(swig::make_set_nonconst_iterator(static_cast< const std::set< int >::iterator & >(result),
...
/*
  Document-method: Example::IntSet.rbegin

  call-seq:
    rbegin -> std::set< int >::reverse_iterator

Return a reverse iterator to the beginning (the end) of the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_rbegin(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","rbegin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (arg1)->rbegin();
  vresult = SWIG_NewPointerObj(swig::make_set_nonconst_iterator(static_cast< const std::set< int >::reverse_iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  return vresult;
fail:
...
/*
  Document-method: Example::IntSet.rend

  call-seq:
    rend -> std::set< int >::reverse_iterator

Return a reverse iterator to past the end (past the beginning) of the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_rend(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::set< int >::reverse_iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","rend", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  result = (arg1)->rend();
  vresult = SWIG_NewPointerObj(swig::make_set_nonconst_iterator(static_cast< const std::set< int >::reverse_iterator & >(result),
...
*/
SWIGINTERN VALUE
_wrap_IntSet_erase__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  ...
  res2 = SWIG_ConvertPtr(argv[0], SWIG_as_voidptrptr(&iter2), swig::Iterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::set< int >::iterator","erase", 2, argv[0] ));
  } else {
    swig::Iterator_T<std::set< int >::iterator > *iter_t = dynamic_cast<swig::Iterator_T<std::set< int >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::set< int >::iterator","erase", 2, argv[0] ));
...
SWIGINTERN VALUE
_wrap_IntSet_erase__SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::iterator arg2 ;
  ...
  res3 = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter3), swig::Iterator::descriptor(), 0);
  if (!SWIG_IsOK(res3) || !iter3) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::set< int >::iterator","erase", 3, argv[1] ));
  } else {
    swig::Iterator_T<std::set< int >::iterator > *iter_t = dynamic_cast<swig::Iterator_T<std::set< int >::iterator > *>(iter3);
    if (iter_t) {
      arg3 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), Ruby_Format_TypeError( "", "std::set< int >::iterator","erase", 3, argv[1] ));
...
SWIGINTERN VALUE _wrap_IntSet_erase(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      int res = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter), 
        swig::Iterator::descriptor(), 0);
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::Iterator_T<std::set< int >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_IntSet_erase__SWIG_1(nargs, args, self);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_IntSet_erase__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::Iterator_T<std::set< int >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_IntSet_erase__SWIG_2(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "IntSet.erase", 
    "    void IntSet.erase(std::set< int >::key_type const &x)\n"
    "    void IntSet.erase(std::set< int >::iterator pos)\n"
    "    void IntSet.erase(std::set< int >::iterator first, std::set< int >::iterator last)\n");
...
/*
  Document-method: Example::IntSet.find

  call-seq:
    find(x) -> std::set< int >::iterator

Find an element in the class.
*/
SWIGINTERN VALUE
_wrap_IntSet_find(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","find", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::key_type","find", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::key_type >(val2);
  arg2 = &temp2;
...
SWIGINTERN VALUE
_wrap_IntSet_lower_bound(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","lower_bound", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::key_type","lower_bound", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::key_type >(val2);
  arg2 = &temp2;
...
SWIGINTERN VALUE
_wrap_IntSet_upper_bound(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","upper_bound", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::key_type","upper_bound", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::key_type >(val2);
  arg2 = &temp2;
...
SWIGINTERN VALUE
_wrap_IntSet_equal_range(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","equal_range", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::key_type","equal_range", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::key_type >(val2);
  arg2 = &temp2;
  result = (arg1)->equal_range((std::set< int >::key_type const &)*arg2);
  vresult = rb_ary_new2(2);
  rb_ary_push(vresult, SWIG_NewPointerObj(swig::make_const_iterator(static_cast< const std::pair< std::set< int >::iterator,std::set< int >::iterator > & >(result).first),
      swig::ConstIterator::descriptor(),SWIG_POINTER_OWN));
  rb_ary_push(vresult, SWIG_NewPointerObj(swig::make_const_iterator(static_cast< const std::pair< std::set< int >::iterator,std::set< int >::iterator > & >(result).second),
      swig::ConstIterator::descriptor(),SWIG_POINTER_OWN));
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::IntSet.insert

  call-seq:
    insert(x) -> std::pair< std::set< int >::iterator,bool >

Insert one or more new elements in the IntSet.
*/
SWIGINTERN VALUE
_wrap_IntSet_insert(int argc, VALUE *argv, VALUE self) {
  std::set< int > *arg1 = (std::set< int > *) 0 ;
  std::set< int >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::set< int > *","insert", 1, self )); 
  }
  arg1 = reinterpret_cast< std::set< int > * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "std::set< int >::value_type","insert", 2, argv[0] ));
  } 
  temp2 = static_cast< std::set< int >::value_type >(val2);
  arg2 = &temp2;
  result = (arg1)->insert((std::set< int >::value_type const &)*arg2);
  vresult = rb_ary_new2(2);
  rb_ary_push(vresult, SWIG_NewPointerObj(swig::make_set_nonconst_iterator(static_cast< std::pair< std::set< int >::iterator,bool > & >(result).first),
      swig::Iterator::descriptor(),SWIG_POINTER_OWN));
  rb_ary_push(vresult, SWIG_From_bool  (static_cast< const std::pair< std::set< int >::iterator,bool > & >(result).second));
  return vresult;
fail:
  return Qnil;
}
...
SWIGINTERN void
free_std_set_Sl_int_Sg_(std::set< int > *arg1) {
    delete arg1;
}

static swig_class SwigClassImap;

SWIGINTERN VALUE
_wrap_new_Imap__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::less< swig::GC_VALUE > *arg1 = 0 ;
  void *argp1 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE > *result = 0 ;
  
  if ((argc < 1) || (argc > 1)) {
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 1)",argc); SWIG_fail;
  }
  res1 = SWIG_ConvertPtr(argv[0], &argp1, SWIGTYPE_p_std__lessT_swig__GC_VALUE_t,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::less< swig::GC_VALUE > const &","map<(swig::GC_VALUE,swig::GC_VALUE)>", 1, argv[0] )); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::less< swig::GC_VALUE > const &","map<(swig::GC_VALUE,swig::GC_VALUE)>", 1, argv[0])); 
  }
  arg1 = reinterpret_cast< std::less< swig::GC_VALUE > * >(argp1);
  result = (std::map< swig::GC_VALUE,swig::GC_VALUE > *)new std::map< swig::GC_VALUE,swig::GC_VALUE >((std::less< swig::GC_VALUE > const &)*arg1);
  DATA_PTR(self) = result;
  return self;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.dup
...
*/
SWIGINTERN VALUE
_wrap_Imap_dup(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *result = 0 ;
  VALUE vresult = Qnil;
  
  if ((argc < 0) || (argc > 0)) {
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc); SWIG_fail;
  }
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","dup", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__dup(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  Document-method: Example::Imap.delete
...
*/
SWIGINTERN VALUE
_wrap_Imap_delete(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::GC_VALUE r2 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","__delete__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg____delete__(arg1,(swig::GC_VALUE const &)*arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_has_keyq___(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > const *","has_key", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = (bool)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__has_key((std::map< swig::GC_VALUE,swig::GC_VALUE > const *)arg1,(swig::GC_VALUE const &)*arg2);
  vresult = SWIG_From_bool(static_cast< bool >(result));
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.keys
...
*/
SWIGINTERN VALUE
_wrap_Imap_keys(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","keys", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__keys(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.each

  call-seq:
    each -> Imap

Iterate thru each element in the Imap.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_Imap_each(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","each", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__each(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  Document-method: Example::Imap.select

  call-seq:
    select -> Imap

Iterate thru each element in the Imap and select those that match a condition.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_Imap_select(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","select", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__select(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.values_at
...
*/
SWIGINTERN VALUE
_wrap_Imap_values_at(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  int arg2 ;
  VALUE *arg3 = (VALUE *) 0 ;
  void *arg4 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","values_at", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  {
    arg2 = argc;
  ...
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__values_at(arg1,arg2,arg3,arg4);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.each_key

  call-seq:
    each_key -> Imap

Iterate thru each key element in the Imap.  A block must be provided.
*/
SWIGINTERN VALUE
_wrap_Imap_each_key(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","each_key", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__each_key(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.values
...
*/
SWIGINTERN VALUE
_wrap_Imap_values(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","values", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__values(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.each_value
...
*/
SWIGINTERN VALUE
_wrap_Imap_each_value(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","each_value", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__each_value(arg1);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_entries(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","entries", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__entries(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_includeq___(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","__contains__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = (bool)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg____contains__(arg1,(swig::GC_VALUE const &)*arg2);
  vresult = SWIG_From_bool(static_cast< bool >(result));
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_key_iterator(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  VALUE *arg2 = (VALUE *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","key_iterator", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (swig::ConstIterator *)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__key_iterator(arg1,arg2);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__ConstIterator, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_value_iterator(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  VALUE *arg2 = (VALUE *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","value_iterator", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (swig::ConstIterator *)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__value_iterator(arg1,arg2);
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__ConstIterator, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
*/
SWIGINTERN VALUE
_wrap_Imap___getitem__(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > const *","__getitem__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg____getitem__((std::map< swig::GC_VALUE,swig::GC_VALUE > const *)arg1,(swig::GC_VALUE const &)*arg2);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
*/
SWIGINTERN VALUE
_wrap_Imap___setitem__(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::mapped_type *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::GC_VALUE r2 ;
  swig::GC_VALUE r3 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","__setitem__", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  r3 = argv[1]; arg3 = &r3;
  try {
    std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg____setitem__(arg1,(swig::GC_VALUE const &)*arg2,(swig::GC_VALUE const &)*arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
/*
  Document-method: Example::Imap.inspect
...
*/
SWIGINTERN VALUE
_wrap_Imap_inspect(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","inspect", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__inspect(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.to_a

  call-seq:
    to_a -> VALUE

Convert Imap to an Array.
*/
SWIGINTERN VALUE
_wrap_Imap_to_a(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","to_a", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__to_a(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.to_s
...
*/
SWIGINTERN VALUE
_wrap_Imap_to_s(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  VALUE result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","to_s", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (VALUE)std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg__to_s(arg1);
  vresult = result;
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_new_Imap__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *result = 0 ;
  
  if ((argc < 0) || (argc > 0)) {
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 0)",argc); SWIG_fail;
  }
  result = (std::map< swig::GC_VALUE,swig::GC_VALUE > *)new std::map< swig::GC_VALUE,swig::GC_VALUE >();
  DATA_PTR(self) = result;
  return self;
fail:
  return Qnil;
...
#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_Imap_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_Imap_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_Imap__SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  std::map< swig::GC_VALUE,swig::GC_VALUE > *result = 0 ;
  ...
  {
    std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *ptr = (std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *)0;
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > const &","map<(swig::GC_VALUE,swig::GC_VALUE)>", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::map< swig::GC_VALUE,swig::GC_VALUE > const &","map<(swig::GC_VALUE,swig::GC_VALUE)>", 1, argv[0])); 
    }
    arg1 = ptr;
  }
  result = (std::map< swig::GC_VALUE,swig::GC_VALUE > *)new std::map< swig::GC_VALUE,swig::GC_VALUE >((std::map< swig::GC_VALUE,swig::GC_VALUE > const &)*arg1);
  DATA_PTR(self) = result;
  if (SWIG_IsNewObj(res1)) delete arg1;
  return self;
fail:
...
SWIGINTERN VALUE _wrap_new_Imap(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[1];
  int ii;
  ...
  if (argc == 0) {
    return _wrap_new_Imap__SWIG_1(nargs, args, self);
  }
  if (argc == 1) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_std__lessT_swig__GC_VALUE_t, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_Imap__SWIG_0(nargs, args, self);
    }
  }
  if (argc == 1) {
    int _v;
    int res = swig::asptr(argv[0], (std::map<swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >**)(0));
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_Imap__SWIG_2(nargs, args, self);
    }
  }
  
fail:
  Ruby_Format_OverloadedError( argc, 1, "Imap.new", 
    "    Imap.new(std::less< swig::GC_VALUE > const &)\n"
    "    Imap.new()\n"
    "    Imap.new(std::map< swig::GC_VALUE,swig::GC_VALUE > const &)\n");
...
/*
  Document-method: Example::Imap.empty?

  call-seq:
    empty? -> bool

Check if the Imap is empty or not.
*/
SWIGINTERN VALUE
_wrap_Imap_emptyq___(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  bool result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > const *","empty", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (bool)((std::map< swig::GC_VALUE,swig::GC_VALUE > const *)arg1)->empty();
  vresult = SWIG_From_bool(static_cast< bool >(result));
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.size

  call-seq:
    size -> std::map< swig::GC_VALUE,swig::GC_VALUE >::size_type

Size or Length of the Imap.
*/
SWIGINTERN VALUE
_wrap_Imap_size(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::size_type result;
  VALUE vresult = Qnil;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > const *","size", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = ((std::map< swig::GC_VALUE,swig::GC_VALUE > const *)arg1)->size();
  vresult = SWIG_From_size_t(static_cast< size_t >(result));
  return vresult;
fail:
  return Qnil;
...
/*
  Document-method: Example::Imap.clear
...
*/
SWIGINTERN VALUE
_wrap_Imap_clear(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","clear", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  (arg1)->clear();
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_swap(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","swap", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > &","swap", 2, argv[0] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::map< swig::GC_VALUE,swig::GC_VALUE > &","swap", 2, argv[0])); 
  }
  arg2 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp2);
  (arg1)->swap(*arg2);
  return Qnil;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_get_allocator(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  SwigValueWrapper< std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > result;
  VALUE vresult = Qnil;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > const *","get_allocator", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = ((std::map< swig::GC_VALUE,swig::GC_VALUE > const *)arg1)->get_allocator();
  vresult = SWIG_NewPointerObj((new std::map< swig::GC_VALUE,swig::GC_VALUE >::allocator_type(static_cast< const std::map< swig::GC_VALUE,swig::GC_VALUE >::allocator_type& >(result))), SWIGTYPE_p_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  Document-method: Example::Imap.begin

  call-seq:
    begin -> std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator

Return an iterator to the beginning of the Imap.
*/
SWIGINTERN VALUE
_wrap_Imap_begin(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator result;
  VALUE vresult = Qnil;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","begin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (arg1)->begin();
  vresult = SWIG_NewPointerObj((new std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator(static_cast< const std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator& >(result))), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  Document-method: Example::Imap.end

  call-seq:
    end -> std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator

Return an iterator to past the end of the Imap.
*/
SWIGINTERN VALUE
_wrap_Imap_end(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","end", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (arg1)->end();
  vresult = SWIG_NewPointerObj((new std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator(static_cast< const std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator& >(result))), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator, SWIG_POINTER_OWN |  0 );
...
/*
  Document-method: Example::Imap.rbegin

  call-seq:
    rbegin -> std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator

Return a reverse iterator to the beginning (the end) of the Imap.
*/
SWIGINTERN VALUE
_wrap_Imap_rbegin(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator result;
  VALUE vresult = Qnil;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","rbegin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (arg1)->rbegin();
  vresult = SWIG_NewPointerObj((new std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator(static_cast< const std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator& >(result))), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  Document-method: Example::Imap.rend

  call-seq:
    rend -> std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator

Return a reverse iterator to past the end (past the beginning) of the Imap.
*/
SWIGINTERN VALUE
_wrap_Imap_rend(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","rend", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  result = (arg1)->rend();
  vresult = SWIG_NewPointerObj((new std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator(static_cast< const std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator& >(result))), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator, SWIG_POINTER_OWN |  0 );
...
/*
  Document-method: Example::Imap.erase

  call-seq:
    erase(x) -> std::map< swig::GC_VALUE,swig::GC_VALUE >::size_type
    erase(position)
    erase(first, last)

Delete a portion of the Imap.
*/
SWIGINTERN VALUE
_wrap_Imap_erase__SWIG_0(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","erase", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = (arg1)->erase((std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &)*arg2);
  vresult = SWIG_From_size_t(static_cast< size_t >(result));
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_count(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > const *","count", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = ((std::map< swig::GC_VALUE,swig::GC_VALUE > const *)arg1)->count((std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &)*arg2);
  vresult = SWIG_From_size_t(static_cast< size_t >(result));
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_erase__SWIG_1(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  int res2 = 0 ;
  ...
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  {
    res2 = SWIG_ConvertPtr(argv[0], &argp2, SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator","erase", 2, argv[0] )); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator","erase", 2, argv[0]));
    } else {
      arg2 = *(reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator * >(argp2));
    }
  }
  (arg1)->erase(arg2);
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_erase__SWIG_2(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator arg2 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 ;
  int res2 = 0 ;
  ...
  {
    res3 = SWIG_ConvertPtr(argv[1], &argp3, SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator,  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator","erase", 3, argv[1] )); 
    }  
    if (!argp3) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator","erase", 3, argv[1]));
    } else {
      arg3 = *(reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator * >(argp3));
    }
  }
  (arg1)->erase(arg2,arg3);
  return Qnil;
...
SWIGINTERN VALUE _wrap_Imap_erase(int nargs, VALUE *args, VALUE self) {
  int argc;
  VALUE argv[4];
  int ii;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      void *vptr = 0;
      int res = SWIG_ConvertPtr(argv[1], &vptr, SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_Imap_erase__SWIG_1(nargs, args, self);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      _v = 1;
      if (_v) {
        return _wrap_Imap_erase__SWIG_0(nargs, args, self);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_Imap_erase__SWIG_2(nargs, args, self);
        }
      }
    }
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Imap.erase", 
    "    void Imap.erase(std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &x)\n"
    "    void Imap.erase(std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator position)\n"
    "    void Imap.erase(std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator first, std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator last)\n");
...
/*
  Document-method: Example::Imap.find

  call-seq:
    find(x) -> std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator

Find an element in the class.
*/
SWIGINTERN VALUE
_wrap_Imap_find(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","find", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = (arg1)->find((std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &)*arg2);
  vresult = SWIG_NewPointerObj((new std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator(static_cast< const std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator& >(result))), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_lower_bound(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","lower_bound", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = (arg1)->lower_bound((std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &)*arg2);
  vresult = SWIG_NewPointerObj((new std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator(static_cast< const std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator& >(result))), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN VALUE
_wrap_Imap_upper_bound(int argc, VALUE *argv, VALUE self) {
  std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1 = (std::map< swig::GC_VALUE,swig::GC_VALUE > *) 0 ;
  std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::map< swig::GC_VALUE,swig::GC_VALUE > *","upper_bound", 1, self )); 
  }
  arg1 = reinterpret_cast< std::map< swig::GC_VALUE,swig::GC_VALUE > * >(argp1);
  r2 = argv[0]; arg2 = &r2;
  result = (arg1)->upper_bound((std::map< swig::GC_VALUE,swig::GC_VALUE >::key_type const &)*arg2);
  vresult = SWIG_NewPointerObj((new std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator(static_cast< const std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator& >(result))), SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
...
SWIGINTERN void
free_std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg_(std::map< swig::GC_VALUE,swig::GC_VALUE > *arg1) {
    delete arg1;
}
...
static swig_type_info _swigt__p_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t = {"_p_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t", "std::map< swig::GC_VALUE,swig::GC_VALUE >::allocator_type *|std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__lessT_int_t = {"_p_std__lessT_int_t", "std::less< int > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__lessT_swig__GC_VALUE_t = {"_p_std__lessT_swig__GC_VALUE_t", "std::less< swig::GC_VALUE > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t = {"_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t", "std::map< swig::GC_VALUE,swig::GC_VALUE > *|std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator = {"_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator", "std::map< swig::GC_VALUE,swig::GC_VALUE >::iterator *|std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::iterator *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator = {"_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator", "std::map< swig::GC_VALUE,swig::GC_VALUE >::reverse_iterator *|std::map< swig::GC_VALUE,swig::GC_VALUE,std::less< swig::GC_VALUE >,std::allocator< std::pair< swig::GC_VALUE const,swig::GC_VALUE > > >::reverse_iterator *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t,
  &_swigt__p_std__lessT_int_t,
  &_swigt__p_std__lessT_swig__GC_VALUE_t,
  &_swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t,
  &_swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator,
  &_swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator,
...
static swig_cast_info _swigc__p_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t[] = {  {&_swigt__p_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__lessT_int_t[] = {  {&_swigt__p_std__lessT_int_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__lessT_swig__GC_VALUE_t[] = {  {&_swigt__p_std__lessT_swig__GC_VALUE_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t[] = {  {&_swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator[] = {  {&_swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator[] = {  {&_swigt__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t,
  _swigc__p_std__lessT_int_t,
  _swigc__p_std__lessT_swig__GC_VALUE_t,
  _swigc__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t,
  _swigc__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__iterator,
  _swigc__p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t__reverse_iterator,
...
SWIGEXPORT void Init_example(void) {
  ...
  SwigClassSquare.klass = rb_define_class_under(mExample, "Square", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Square, (void *) &SwigClassSquare);
  rb_define_alloc_func(SwigClassSquare.klass, _wrap_Square_allocate);
  rb_define_method(SwigClassSquare.klass, "initialize", VALUEFUNC(_wrap_new_Square), -1);
  rb_define_method(SwigClassSquare.klass, "x=", VALUEFUNC(_wrap_Square_x_set), -1);
  rb_define_method(SwigClassSquare.klass, "x", VALUEFUNC(_wrap_Square_x_get), -1);
  rb_define_method(SwigClassSquare.klass, "y=", VALUEFUNC(_wrap_Square_y_set), -1);
  rb_define_method(SwigClassSquare.klass, "y", VALUEFUNC(_wrap_Square_y_get), -1);
  rb_define_method(SwigClassSquare.klass, "area", VALUEFUNC(_wrap_Square_area), -1);
  rb_define_method(SwigClassSquare.klass, "perimeter", VALUEFUNC(_wrap_Square_perimeter), -1);
  SwigClassSquare.mark = 0;
  SwigClassSquare.destroy = (void (*)(void *)) free_Square;
  SwigClassSquare.trackObjects = 0;
  rb_define_module_function(mExample, "fibonacci", VALUEFUNC(_wrap_fibonacci), -1);
  rb_define_const(mExample, "FOO", SWIG_From_int(static_cast< int >(42)));
  rb_define_const(mExample, "PI", SWIG_From_double(static_cast< double >(3.14159)));
  ...
  SwigClassIntVector.klass = rb_define_class_under(mExample, "IntVector", rb_cObject);
  ...
  SwigClassIntSet.klass = rb_define_class_under(mExample, "IntSet", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_std__setT_int_std__lessT_int_t_std__allocatorT_int_t_t, (void *) &SwigClassIntSet);
  rb_include_module(SwigClassIntSet.klass, rb_eval_string("Enumerable"));
  rb_define_alloc_func(SwigClassIntSet.klass, _wrap_IntSet_allocate);
  rb_define_method(SwigClassIntSet.klass, "initialize", VALUEFUNC(_wrap_new_IntSet), -1);
  rb_define_method(SwigClassIntSet.klass, "dup", VALUEFUNC(_wrap_IntSet_dup), -1);
  rb_define_method(SwigClassIntSet.klass, "inspect", VALUEFUNC(_wrap_IntSet_inspect), -1);
  rb_define_method(SwigClassIntSet.klass, "to_a", VALUEFUNC(_wrap_IntSet_to_a), -1);
  rb_define_method(SwigClassIntSet.klass, "to_s", VALUEFUNC(_wrap_IntSet_to_s), -1);
  rb_define_method(SwigClassIntSet.klass, "slice", VALUEFUNC(_wrap_IntSet_slice), -1);
  rb_define_method(SwigClassIntSet.klass, "each", VALUEFUNC(_wrap_IntSet_each), -1);
  rb_define_method(SwigClassIntSet.klass, "select", VALUEFUNC(_wrap_IntSet_select), -1);
  rb_define_method(SwigClassIntSet.klass, "delete_at", VALUEFUNC(_wrap_IntSet_delete_at), -1);
  rb_define_method(SwigClassIntSet.klass, "__delete2__", VALUEFUNC(_wrap_IntSet___delete2__), -1);
  rb_define_method(SwigClassIntSet.klass, "reject!", VALUEFUNC(_wrap_IntSet_rejectN___), -1);
  rb_define_alias(SwigClassIntSet.klass, "delete_if", "reject!");
  rb_define_method(SwigClassIntSet.klass, "push", VALUEFUNC(_wrap_IntSet_push), -1);
  rb_define_alias(SwigClassIntSet.klass, "<<", "push");
  rb_define_method(SwigClassIntSet.klass, "include?", VALUEFUNC(_wrap_IntSet_includeq___), -1);
  rb_define_method(SwigClassIntSet.klass, "[]", VALUEFUNC(_wrap_IntSet___getitem__), -1);
  rb_define_method(SwigClassIntSet.klass, "empty?", VALUEFUNC(_wrap_IntSet_emptyq___), -1);
  rb_define_method(SwigClassIntSet.klass, "size", VALUEFUNC(_wrap_IntSet_size), -1);
  rb_define_method(SwigClassIntSet.klass, "clear", VALUEFUNC(_wrap_IntSet_clear), -1);
  rb_define_method(SwigClassIntSet.klass, "swap", VALUEFUNC(_wrap_IntSet_swap), -1);
  rb_define_method(SwigClassIntSet.klass, "count", VALUEFUNC(_wrap_IntSet_count), -1);
  rb_define_method(SwigClassIntSet.klass, "begin", VALUEFUNC(_wrap_IntSet_begin), -1);
  rb_define_method(SwigClassIntSet.klass, "end", VALUEFUNC(_wrap_IntSet_end), -1);
  rb_define_method(SwigClassIntSet.klass, "rbegin", VALUEFUNC(_wrap_IntSet_rbegin), -1);
  rb_define_method(SwigClassIntSet.klass, "rend", VALUEFUNC(_wrap_IntSet_rend), -1);
  rb_define_method(SwigClassIntSet.klass, "erase", VALUEFUNC(_wrap_IntSet_erase), -1);
  rb_define_method(SwigClassIntSet.klass, "find", VALUEFUNC(_wrap_IntSet_find), -1);
  rb_define_method(SwigClassIntSet.klass, "lower_bound", VALUEFUNC(_wrap_IntSet_lower_bound), -1);
  rb_define_method(SwigClassIntSet.klass, "upper_bound", VALUEFUNC(_wrap_IntSet_upper_bound), -1);
  rb_define_method(SwigClassIntSet.klass, "equal_range", VALUEFUNC(_wrap_IntSet_equal_range), -1);
  rb_define_method(SwigClassIntSet.klass, "insert", VALUEFUNC(_wrap_IntSet_insert), -1);
  SwigClassIntSet.mark = 0;
  SwigClassIntSet.destroy = (void (*)(void *)) free_std_set_Sl_int_Sg_;
  SwigClassIntSet.trackObjects = 0;
  
  SwigClassImap.klass = rb_define_class_under(mExample, "Imap", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_std__mapT_swig__GC_VALUE_swig__GC_VALUE_std__lessT_swig__GC_VALUE_t_std__allocatorT_std__pairT_swig__GC_VALUE_const_swig__GC_VALUE_t_t_t, (void *) &SwigClassImap);
  rb_include_module(SwigClassImap.klass, rb_eval_string("Enumerable"));
  rb_define_alloc_func(SwigClassImap.klass, _wrap_Imap_allocate);
  rb_define_method(SwigClassImap.klass, "initialize", VALUEFUNC(_wrap_new_Imap), -1);
  rb_define_method(SwigClassImap.klass, "dup", VALUEFUNC(_wrap_Imap_dup), -1);
  rb_define_method(SwigClassImap.klass, "delete", VALUEFUNC(_wrap_Imap_delete), -1);
  rb_define_method(SwigClassImap.klass, "has_key?", VALUEFUNC(_wrap_Imap_has_keyq___), -1);
  rb_define_method(SwigClassImap.klass, "keys", VALUEFUNC(_wrap_Imap_keys), -1);
  rb_define_method(SwigClassImap.klass, "each", VALUEFUNC(_wrap_Imap_each), -1);
  rb_define_method(SwigClassImap.klass, "select", VALUEFUNC(_wrap_Imap_select), -1);
  rb_define_method(SwigClassImap.klass, "values_at", VALUEFUNC(_wrap_Imap_values_at), -1);
  rb_define_method(SwigClassImap.klass, "each_key", VALUEFUNC(_wrap_Imap_each_key), -1);
  rb_define_method(SwigClassImap.klass, "values", VALUEFUNC(_wrap_Imap_values), -1);
  rb_define_method(SwigClassImap.klass, "each_value", VALUEFUNC(_wrap_Imap_each_value), -1);
  rb_define_method(SwigClassImap.klass, "entries", VALUEFUNC(_wrap_Imap_entries), -1);
  rb_define_method(SwigClassImap.klass, "include?", VALUEFUNC(_wrap_Imap_includeq___), -1);
  rb_define_method(SwigClassImap.klass, "key_iterator", VALUEFUNC(_wrap_Imap_key_iterator), -1);
  rb_define_method(SwigClassImap.klass, "value_iterator", VALUEFUNC(_wrap_Imap_value_iterator), -1);
  rb_define_method(SwigClassImap.klass, "[]", VALUEFUNC(_wrap_Imap___getitem__), -1);
  rb_define_method(SwigClassImap.klass, "[]=", VALUEFUNC(_wrap_Imap___setitem__), -1);
  rb_define_method(SwigClassImap.klass, "inspect", VALUEFUNC(_wrap_Imap_inspect), -1);
  rb_define_method(SwigClassImap.klass, "to_a", VALUEFUNC(_wrap_Imap_to_a), -1);
  rb_define_method(SwigClassImap.klass, "to_s", VALUEFUNC(_wrap_Imap_to_s), -1);
  rb_define_method(SwigClassImap.klass, "empty?", VALUEFUNC(_wrap_Imap_emptyq___), -1);
  rb_define_method(SwigClassImap.klass, "size", VALUEFUNC(_wrap_Imap_size), -1);
  rb_define_method(SwigClassImap.klass, "clear", VALUEFUNC(_wrap_Imap_clear), -1);
  rb_define_method(SwigClassImap.klass, "swap", VALUEFUNC(_wrap_Imap_swap), -1);
  rb_define_method(SwigClassImap.klass, "get_allocator", VALUEFUNC(_wrap_Imap_get_allocator), -1);
  rb_define_method(SwigClassImap.klass, "begin", VALUEFUNC(_wrap_Imap_begin), -1);
  rb_define_method(SwigClassImap.klass, "end", VALUEFUNC(_wrap_Imap_end), -1);
  rb_define_method(SwigClassImap.klass, "rbegin", VALUEFUNC(_wrap_Imap_rbegin), -1);
  rb_define_method(SwigClassImap.klass, "rend", VALUEFUNC(_wrap_Imap_rend), -1);
  rb_define_method(SwigClassImap.klass, "count", VALUEFUNC(_wrap_Imap_count), -1);
  rb_define_method(SwigClassImap.klass, "erase", VALUEFUNC(_wrap_Imap_erase), -1);
  rb_define_method(SwigClassImap.klass, "find", VALUEFUNC(_wrap_Imap_find), -1);
  rb_define_method(SwigClassImap.klass, "lower_bound", VALUEFUNC(_wrap_Imap_lower_bound), -1);
  rb_define_method(SwigClassImap.klass, "upper_bound", VALUEFUNC(_wrap_Imap_upper_bound), -1);
  SwigClassImap.mark = 0;
  SwigClassImap.destroy = (void (*)(void *)) free_std_map_Sl_swig_GC_VALUE_Sc_swig_GC_VALUE_Sg_;
  SwigClassImap.trackObjects = 0;
}
